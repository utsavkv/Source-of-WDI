...
--->
Created a Parallel Coordinates Plot with 5 indicators to compare environmental trends in these         multivariate continuous variables. 

Indicators used are as follows:
     1. Agricultural land (% of land area) - AG.LND.AGRI.ZS
     2. Child employment in agriculture (% of economically active children ages 7-14) - SL.AGR.0714.ZS
     3. CO2 emissions (metric tons per capita) - EN.ATM.CO2E.PC
     4. Forest area (% of land area) - AG.LND.FRST.ZS
     5. Fossil fuel energy consumption (% of total) - EG.USE.COMM.FO.ZS
--->
...
ggparcoord(df.pcp, columns=3:7, groupColumn=2, alpha=0.15, scale='uniminmax',splineFactor=10,
           title = "Global Environmental Trends through a splined-PCP")
```
